<?php
	...
	if(isset($_POST['submit-vehicle'])) {
		...
		$query=mysqli_query($con, "INSERT into vehicle_info(ParkingNumber,VehicleCompanyname,RegistrationNumber,OwnerName,OwnerContactNumber) value('$parkingnumber','$vehcomp','$vehreno','$ownername','$ownercontno')");
		if ($query) {
