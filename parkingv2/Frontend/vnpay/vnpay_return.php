    ...
    <div class="container">
        ...
        <div class="table-responsive">
            ...
            <div class="form-group">
                ...
                <label>
                    ...
                    if ($vnp_ResponseCode === '00') {
                        try {
                            ...
                            $sql = "UPDATE vehicle_info SET payment_status = 1, latest_action_time = NOW() WHERE order_number = :order_number";
                ...
                <div class="form-group">
                    <a href="../payindex.php" class="btn btn-primary">Home</a>
                </div>
            </div>
        </div>
        <p>
...
<script>
setTimeout(function(){
	window.location.href = '../payindex.php'; 
},6000);// for 5 second redirection
</script>
</html>