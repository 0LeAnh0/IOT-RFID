<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="<?php if($page=="monthly") {echo "active";}?>"><a href="monthly.php"><em class="fa fa-list-alt">&nbsp;</em> Subscription</a></li>
			<li class="<?php if($page=="paymentstatus") {echo "active";}?>"><a href="payindex.php"><em class="fa fa-check-square-o">&nbsp;</em> Payment</a></li>
		</ul>
