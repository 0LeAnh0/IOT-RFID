...
(1, 'Nguyen', 'admin', 7854445410, 1100, 'admin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', '2021-01-05 05:38:23'),
...
INSERT INTO `rfid` (`STT`, `ID`, `PRODUCTNAME`, `reading_time`) VALUES
(1, '7B69A311', 'SANPHAM1', '2023-05-11 01:24:20'),
(2, 'A9C43004', 'SANPHAM2', '2023-05-11 01:25:06');
...
CREATE TABLE `product_info` (
  ...
  `CompanyContactNumber` bigint(10) DEFAULT NULL,
...
-- INSERT INTO `product_info` (`STT`, `ID`, `Companyname`, `ProductName`, `OwnerName`, `CompanyContactNumber`, `InTime`, `OutTime`, `ParkingCharge`, `Status`, `order_number`, `latest_action_time`, `payment_status`) VALUES
